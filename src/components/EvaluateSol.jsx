          ...
          <>
            <div className="bg-[#181B2E] rounded-t-[10px] sm:p-[15px] px-2 py-1  sm:px-[20px]">
                  ...
                  {loading ? (
                    ...
                    <>
                      ...
                      <div className="flex gap-2 items-baseline">
                        ...
                        <p className="text-[12px] sm:text-xs font-light">
                          (
                          {valueFetch?.tokenInformation?.generalInformation
                            ?.tokenSymbol || "Symbol"}
                          )
              ...
              <p className="text-xs text-white flex items-center w-72 ">
                {selectedToken && (
                  <span className="mr-2 bg-[#300D5A] p-1 sm:p-[6px] px-2 sm:px-4 rounded-[5px] text-sm flex justify-center gap-1 items-center">
                    <img
                ...
                {loading ? (
                  ...
                  (
                    <p className="overflow-visible text-[9px] sm:text-xs scrollbar-hide">
                      {" "}
                      {tokenAddress}{" "}
                    </p>
                  ) || "Enter Token Address"
        ...
        {ercerror && (
          <div className="m-5 flex flex-col justify-center items-center py-3 pt-4">
            ...
            <p className=" text-3xl  flex gap-4  ">
              {" "}
              <img
                src={"https://check.quillai.network/icons/X.svg"}
                className="w-7 "
                alt="x"
              />{" "}
              ERC-20 contract not be found at the given address{" "}
            </p>{" "}
            <br />
            ...
            <div>
              <button className="underline" onClick={onBackClick}>
                Go back
              </button>
            </div>
          </div>
