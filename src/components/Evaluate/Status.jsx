    ...
    <div>
      <div className="flex gap-1.5 sm:gap-4 text-xs sm:text-sm">
        <div className="space-y-1 sm:space-y-3">
          <div className="">
            <p className="text-[#DDDDDD] text-[12px]  sm:text-base">
              Last Known Status:
            </p>
            <div
              className="h-7 sm:h-10 w-fit rounded-[8px] px-1 sm:p-[10px] flex items-center gap-1 sm:gap-2"
              style={{ backgroundColor: honeypotBgColor }} // Set honeypot background color
            >
              <img className="h-4 sm:h-6" src={honeypotIcon} alt="" />{" "}
              {/* Set honeypot asset */}
              <p className="text-[11px]  leading-3 sm:text-xs sm:flex">
                {honeypotStatus}
              </p>
            </div>
          </div>
          <div className="w-fit">
            <p className="text-[#DDDDDD] text-xs sm:text-base mt-1">Token Age:</p>
        ...
        <div className="space-y-3">
          <div className="w-fit">
            ...
            <p
              className="h-7 sm:h-10 w-full rounded-[8px] flex justify-center items-center mx-auto"
              style={{ backgroundColor: getBackgroundColor(totalScore) }} // Set background color dynamically
            >
          ...
          <div className="w-fit cursor-pointer" onClick={handleCopy}>
            <p className="text-[#DDDDDD] text-xs sm:text-base -mt-2">Ownership:</p>
            {owner !== "" && owner !== "Renounced" ? (
              ...
              <>
                {owner === "Renounced" ? (
                  ...
                  <img className="h-3 sm:h-4 mx-auto" src={Assets.X} alt="X" />
                )}
              </>
            )}
          </div>
